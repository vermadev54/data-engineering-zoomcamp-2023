...
from settings import INPUT_DATA_PATH_fhv, KAFKA_TOPIC_fhv
...
if __name__ == '__main__':
    ...
    rides = producer.read_records(resource_path=INPUT_DATA_PATH_fhv)
    #print(rides)
    producer.publish_rides(topic=KAFKA_TOPIC_fhv, messages=rides)
